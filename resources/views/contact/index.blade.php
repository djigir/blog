        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-11 mx-auto">
                    <h1 class="edica-page-title aos-init aos-animate" data-aos="fade-up">Contact</h1>
                    <section class="edica-contact py-5 mb-5">
                        <div class="row">
                            <div class="col-md-8 contact-form-wrapper">
                                <h5 data-aos="fade-up" class="aos-init aos-animate">Contact form</h5>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 aos-init" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <button type="submit" class="btn btn-warning btn-lg aos-init" data-aos="fade-up" data-aos-delay="300">Send Message</button>
                            </div>
